...
Используйте этот навык для управления интеграцией с qBittorrent.

- **Назначение ID и категорий:**
...
- **Принципы работы:** qBittorrent Web API, автоматическая проверка состояния закачек, синхронизация метаданных с `media.db` и актуализация путей сохранения.
