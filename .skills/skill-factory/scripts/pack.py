...
# =============================================================================
# Description:
#   Packages a skill directory from skills/<skill_name> into a
#   distributable .skill archive in the dist/ folder.
#
# Examples:
#   python pack.py skills/project-installer
#   python pack.py project-installer
#
# File: skills/skill-factory/scripts/pack.py
...
SKILLS_ROOT = CURRENT_DIR.parents[2]  # skills/
...
def package_skill(skill_target: str) -> Path:
    ...
    if not target_path.exists():
        # Try finding in skills/<skill_target>
