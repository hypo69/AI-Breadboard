...
#   skills/<skill_name> with SKILL.md, README.md, scripts/, references/,
#   and assets/ folders.
#
# Examples:
#   python init_skill.py my-awesome-skill --description "Description of skill"
#
# File: skills/skill-factory/scripts/init_skill.py
...
PROJECT_ROOT = CURRENT_DIR.parents[3]  # project root
