# -*- coding: utf-8 -*-
# =============================================================================
# Process Name: LibreHardwareMonitor Hardware Service
# =============================================================================
# Description:
#   Ядро интеграции с LibreHardwareMonitor внутри аппаратного стека Windows:
#   опрос Web REST JSON API (:8085/data.json), разбор дерева сенсоров
#   материнской платы, CPU, GPU, накопителей, нормализация метрик и управление
...
"""Сервис интеграции с LibreHardwareMonitor внутри стека Windows Hardware."""
...
class LhmService:
    """Сервис для сбора метрик и управления LibreHardwareMonitor в среде Windows."""
