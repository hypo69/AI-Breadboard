...
#   (python -m apps.windows_defender). Поддерживает запуск консольного дашборда,
...
from apps.windows_defender.core.models import ScanRequest, ScanType
from apps.windows_defender.tui import DefenderTUI
...
def main() -> None:
    ...
    if args.server:
        ...
        from apps.windows_defender.router import init_router
