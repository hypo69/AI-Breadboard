...
class NvidiaCatalogManager:
    ...
    # Встроенный проверенный каталог актуальных и стабильных релизов NVIDIA (DCH 64-bit Windows 10/11)
    DEFAULT_RELEASES = [
        {
            "version": "572.70",
    ...
    def get_releases(
        ...
        Args:
            branch: Фильтр по ветке (Game Ready, Studio и др.).
        ...
        # Сортировка: более новые версии первыми
