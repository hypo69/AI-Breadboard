...
python -m apps.registry_viewer --search "Windows" --hive HKLM --max-results 20

# Экспорт в файл JSON или CSV
python -m apps.registry_viewer --bookmark services --export services.json
python -m apps.registry_viewer --bookmark installed_apps_x64 --export apps.csv
```
