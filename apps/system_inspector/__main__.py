...
def main() -> None:
    ...
    if args.mode == "server":
        ...
        if server_mode == "shared" and args.port == 0:
            print("[System Inspector] App configured in 'shared' server mode.")
            print(f"[System Inspector] API endpoints are routed via the main server (http://{effective_host}:8000).")
