...
- Модель loads в постоянный контекст только **краткие метаданные (name + description)** всех доступных навыков.
- Полный текст инструкций, скрипты, чек-листы и Examples из `SKILL.md` подгружаются в контекст **только тогда, когда пользователь ставит релевантную задачу**.
...
graph TD
    ...
    Match -- "Найдено: tdd-doc-gen" --> Load["Активация: Loading полного SKILL.md"]
...
├── examples/           # Examples входных данных и эталонных результатов
...
2. **Formation инструкций:** Описание шагов, граничных условий и правил обработки ошибок.
...
| Навык | Назначение |
|---|---|
| [`tdd-doc-gen`](file:///c:/Users/onela/AppData/Local/aibreadboard/.agents/skills/tdd-doc-gen/SKILL.md) | Moduleное тестирование и документация изменений кода. |
...
| [`db-inspector`](file:///c:/Users/onela/AppData/Local/aibreadboard/.agents/skills/db-inspector/SKILL.md) | Аудит и check целостности локальных баз SQLite. |
...
1. Навыки позволяют Moduleно расширять возможности ИИ-моделей без раздувания системного промпта.
