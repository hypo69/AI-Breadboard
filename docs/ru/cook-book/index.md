...
4. **Модули памяти (RAG):** Семантический поиск функционирует как внешний Module оперативной памяти, подключенный к шине модели.
...
|---|---|---|
| [**Глава 1**](ch01_philosophy.md) | **Архитектура макетной платы и устройство стенда** | Принцип макетной платы, организация шин, Configuration сокетов в `config.json`, splitting питания и секретов `.env`, лаунчеры PowerShell. |
...
| [**Глава 7**](ch07_skills_management.md) | **Moduleные навыки (Skills) и динамические возможности** | Прогрессивное раскрытие контекста, манифесты `SKILL.md`, иерархия поиска и фабрика навыков `skill-factory`. |
