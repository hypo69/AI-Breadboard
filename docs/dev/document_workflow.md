# Работа с документами в ai-assistant (Август 2026)

## Обзор
Система ai-assistant адаптирована для работы с документами, используя иерархическую структуру, аналогичную медиатеке. Это позволяет управлять как медиаконтентом, так и документацией, таблицами и изображениями в единой экосистеме.
