...
$reqLight = Join-Path $ScriptRoot 'req\requirements-light.txt'
...
# ============================================================
$userModule = Join-Path $ScriptRoot "Install-User.ps1"
if (Test-Path $userModule) {
    & $userModule -InstallDir $ScriptRoot -PythonPath $PythonPath
}
