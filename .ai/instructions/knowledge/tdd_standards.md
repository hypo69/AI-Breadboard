...
| **5** | **Module Docs** | Create/Update `README.md` in module and webinterface directories. | English documentation covering purpose, API table, and architecture. |
...
2. **Directory Documentation (`README.md`):**
   - Every directory created in `src/`, `plugins/`, or `wp/` must contain an English `README.md`.
