...
Перед генерацией тестов **MUST** выполняться проверка: `python -c "from core.module import Class; print('OK')"`.
...
1. **Архитектура BasePlugin:**
   ...
   - Плагины **MUST** реализовывать метод `async def handle(self, message: str, **kwargs)`
   - Поддержка потокового вывода через `yield` **MUST** быть реализована для длительных операций

2. **Динамическая загрузка плагинов:**
   - Новые плагины **MUST** регистрироваться через систему динамической загрузки
   - Конфигурация плагинов **MUST** храниться в `config.json` под ключом `plugins`
   - Отключение плагинов **MUST** выполняться через переменную окружения `DISABLED_PLUGINS`

3. **Манифест плагина:**
   - Каждый плагин **MUST** предоставлять метод `get_manifest()`
...
3. **Обработка ошибок:**
   ...
   - Валидация входных данных **MUST** выполняться через Pydantic модели

4. **Новый роутер агентов:**
   - API для управления агентами **MUST** использовать `/api/agents/` префикс
   - Конфигурация агентов **MUST** сохраняться в отдельном файле конфигурации
...
# -*- coding: utf-8 -*-
# =============================================================================
# Название процесса: Запуск и управление сервисом ai-assistant
# =============================================================================
# Описание:
...
# -*- coding: utf-8 -*-
# =============================================================================
# Название процесса: Запуск FastAPI-сервера ai-assistant
# =============================================================================
# Описание:
...
```yaml
# Конфигурация сборки проекта ai-assistant.
...
```ini
; Конфигурация покрытия тестов проекта ai-assistant.
...
# -*- coding: utf-8 -*-
# =============================================================================
# Название процесса: Единый интерфейс AI моделей
# =============================================================================
# Описание:
...
# -*- coding: utf-8 -*-
# =============================================================================
# Название процесса: [Название плагина]
# =============================================================================
# Описание:
#   [Краткое описание функциональности плагина]
#   [Интеграция с UnifiedChatModel и другими компонентами системы]
#
# Примеры:
...
# -*- coding: utf-8 -*-
# =============================================================================
# Название процесса: Управление конфигурацией AI моделей
# =============================================================================
# Описание:
...
* [ ] Конфигурация AI моделей (Gemini, Foundry, AGY, Ollama) корректно настроена в config.json и .env.
...
* [ ] Интеграция с LangChain корректно настроена и документирована.
