...
def get_google_spreadsheet(user_id: int, spreadsheet_id: str) -> Dict[str, Any]:
    ...
    Returns:
        Dict[str, Any]: Spreadsheet metadata dictionary.
    """
    headers = get_google_headers(user_id)
    if not headers:
        return {}
...
def read_google_spreadsheet_range(user_id: int, spreadsheet_id: str, range_name: str = 'A1:Z100') -> List[List[Any]]:
    ...
    Args:
        user_id (int): User unique identifier.
        spreadsheet_id (str): Google Spreadsheet ID.
        range_name (str): Range in A1 notation (e.g., 'Sheet1!A1:D20').
...
def append_google_spreadsheet_values(
    ...
    Args:
        user_id (int): User unique identifier.
        spreadsheet_id (str): Google Spreadsheet ID.
        range_name (str): Target sheet or range name (e.g., 'Sheet1!A1').
        values (List[List[Any]]): 2D list of row values to append.
...
def update_google_spreadsheet_values(
    ...
    Args:
        user_id (int): User unique identifier.
        spreadsheet_id (str): Google Spreadsheet ID.
        range_name (str): Target range (e.g., 'Sheet1!A1:B2').
        values (List[List[Any]]): 2D list of updated values.
        value_input_option (str): 'USER_ENTERED' or 'RAW'.
