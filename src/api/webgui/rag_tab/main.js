...
function setupEventListeners() {
  const root = document.getElementById('rag-tab-content');
  if (root) {
  ...
  const confirmImportGdocsBtn = document.getElementById('btn-confirm-import-gdocs');
  if (confirmImportGdocsBtn) {
    confirmImportGdocsBtn.addEventListener('click', syncGoogleDocsIntoActiveRag);
  }
