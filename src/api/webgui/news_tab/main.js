...
class NewsTabController {
  ...
  renderArticles() {
    ...
    filtered.forEach((art) => {
      ...
      col.innerHTML = `
        <div class="card h-100 shadow-sm d-flex flex-column" id="news-card-${art.id}">
          ...
          <div class="card-body p-3 d-flex flex-column flex-grow-1">
            <h6 class="card-title fw-bold mb-2">
              <a href="${art.link}" target="_blank" rel="noopener noreferrer" class="text-reset text-decoration-none hover-primary" onclick="window.newsTab?.onArticleRead('${art.id}', '${encodeURIComponent(art.title)}')">
                ${art.title}
              </a>
            </h6>
